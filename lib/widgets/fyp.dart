...
class _ForyouPageState extends State<ForyouPage> {
  ...
  Future<void> following(String followingID) async {
    ...
    upplynotifcation(
        followingID, currentUserID, "follow", "User Followed you", "");
                                                  ...
                                                  Column(
                                                    ...
                                                    children: [
                                                      Text(
                                                          "${userData['name']}"),
                                                      Text(
                                                        "${formatTimestamp1((postData['createdAt'] as Timestamp?)?.toDate())}",
                                                        style: TextStyle(
                                                            fontSize: 8),
                                                      ),
                                                    ],
                                    ...
                                    : GestureDetector(
                                        onTap: () {
                                          ...
                                          if (postData['views'] == null) {
                                            total = 1;
                                            updateviewcount(postData['userID'],
                                                postID, total);
                                          } else if (postData['views'] !=
                                              null) {
                                            // Ensure `views` is treated as an int
                                            int currentViews = postData['views']
                                                    is int
                                                ? postData['views']
