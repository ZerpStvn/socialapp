...
class OwnReposted extends StatefulWidget {
  ...
  const OwnReposted({super.key, this.userData, this.ownpostID});

  @override
  State<OwnReposted> createState() => _OwnRepostedState();
}

class _OwnRepostedState extends State<OwnReposted> {
